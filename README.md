...
4. Select **Transcribe**. The form is disabled while the one allowed active job progresses through validation/download, audio preparation, model loading, transcription, alignment, and output formatting.
